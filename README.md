...
1. Ensure files containing the NTR and TWL blowfish tables are in `encryptor-data`. Please see [DSRomEncryptor README](https://github.com/Gericom/DSRomEncryptor/blob/develop/README.md).
